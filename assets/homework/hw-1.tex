...
\newcommand{\duedate}{September 11, 2026 at 8.59pm via Gradescope}
...
\noindent Using chosen plaintext attacks, show how to learn the secret key for the shift, substitution, and Vigen\`{e}re ciphers. 
Key recovery should be complete (i.e., your attacks should each determine the entirety of the secret key). 
Your attacks should each use only a single plaintext. What is the smallest plaintext length that suffices for each attack? 
\medskip
